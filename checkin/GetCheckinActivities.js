...
//Example with Date
request.get ( 'https://api.bluedotinnovation.com/1/checkinactivities/get?simpleCheckIn"zoneId"='+simpleCheckIn"zoneId"+'&customerApiKey=' + customerApiKey+ "&startdate="+startDate + "&enddate="+ endDate+ "&pagenumber=0",
